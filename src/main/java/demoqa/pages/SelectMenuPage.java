...
public class SelectMenuPage extends BasePage {
    ...
    public SelectMenuPage verifyColorSelected(String[] colors) {
        // Перебираем массив цветов colors
        // boolean флаг, который будет хранить результат совпадения
        // Проходить по списку selectedColorElements
        // Если цвет найден - устанавливать boolean флаг -> true
        // Assert
        for (String color : colors) {
